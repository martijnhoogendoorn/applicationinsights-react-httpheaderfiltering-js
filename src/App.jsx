...
const App = () => {
    ...
    function ajaxRequest() {
        ...
        xhr.open('POST', 'https://httpbin.org/status/200');
        xhr.setRequestHeader('Authorization', 'Bearer blablabla');
        xhr.setRequestHeader('Something', 'SomethingElse');
        xhr.setRequestHeader('SomeOtherThing', 'SomeOtherElse');
        xhr.send();
    }

    function fetchRequest() {
        fetch('https://httpbin.org/status/200', { method: 'POST', headers: { 'Authorization': 'Bearer blablabla', 'someHeader': 'someValue' }});
    }

    return (
      <BrowserRouter>
        <TelemetryProvider instrumentationKey="401d9df3-caba-4ad3-9a76-df52496ba33a" after={() => { appInsights = getAppInsights() }}>
          <div >
            <Header />
